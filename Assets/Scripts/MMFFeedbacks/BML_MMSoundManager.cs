...
{
    public class BML_MMSoundManager : MMPersistentSingleton<BML_MMSoundManager>, 
                                    ...
                                    MMEventListener<MMSoundManagerTrackFadeEvent>
    {
        ...
        /// <returns></returns>
        public virtual AudioSource PlaySound(AudioClip audioClip, MMSoundManager.MMSoundManagerTracks mmSoundManagerTrack, Vector3 location, 
        ...
        public virtual void MuteTrack(MMSoundManager.MMSoundManagerTracks track)
        {
            ControlTrack(track, MMSoundManager.ControlTrackModes.Mute, 0f);
        }
        ...
        /// </summary>
        /// <param name="track"></param>
        public virtual void UnmuteTrack(MMSoundManager.MMSoundManagerTracks track)
        {
            ControlTrack(track, MMSoundManager.ControlTrackModes.Unmute, 0f);
        }
        ...
        {
            ControlTrack(track, MMSoundManager.ControlTrackModes.SetVolume, volume);
        }
        ...
        /// <param name="track"></param>
        /// <param name="volume"></param>
        public virtual float GetTrackVolume(MMSoundManager.MMSoundManagerTracks track, bool mutedVolume)
        {
            switch (track)
            {
                case MMSoundManager.MMSoundManagerTracks.Master:
        ...
        /// </summary>
        /// <param name="track"></param>
        public virtual void PauseTrack(MMSoundManager.MMSoundManagerTracks track)
        {
        ...
        /// </summary>
        /// <param name="track"></param>
        public virtual void PlayTrack(MMSoundManager.MMSoundManagerTracks track)
        {
            foreach (MMSoundManagerSound sound in _sounds)
            {
                if (sound.Track == track)
        ...
        /// </summary>
        /// <param name="track"></param>
        public virtual void StopTrack(MMSoundManager.MMSoundManagerTracks track)
        {
            foreach (MMSoundManagerSound sound in _sounds)
            {
                if (sound.Track == track)
        ...
        /// </summary>
        /// <param name="track"></param>
        public virtual bool HasSoundsPlaying(MMSoundManager.MMSoundManagerTracks track)
        {
            foreach (MMSoundManagerSound sound in _sounds)
            {
        ...
        /// </summary>
        /// <param name="track"></param>
        public virtual void FreeTrack(MMSoundManager.MMSoundManagerTracks track)
        {
            foreach (MMSoundManagerSound sound in _sounds)
            {
                if (sound.Track == track)
        ...
        /// </summary>
        public virtual void MuteMusic() { MuteTrack(MMSoundManager.MMSoundManagerTracks.Music); }
        
        /// <summary>
        /// Unmutes the music track, QoL method ready to bind to a UnityEvent
        /// </summary>
        public virtual void UnmuteMusic() { UnmuteTrack(MMSoundManager.MMSoundManagerTracks.Music); }
        
        /// <summary>
        /// Mutes the sfx track, QoL method ready to bind to a UnityEvent
        /// </summary>
        public virtual void MuteSfx() { MuteTrack(MMSoundManager.MMSoundManagerTracks.Sfx); }
        
        
        /// <summary>
        /// Unmutes the sfx track, QoL method ready to bind to a UnityEvent
        /// </summary>
        public virtual void UnmuteSfx() { UnmuteTrack(MMSoundManager.MMSoundManagerTracks.Sfx); }
        
        /// <summary>
        /// Mutes the UI track, QoL method ready to bind to a UnityEvent
        /// </summary>
        public virtual void MuteUI() { MuteTrack(MMSoundManager.MMSoundManagerTracks.UI); }
        
        /// <summary>
        /// Unmutes the UI track, QoL method ready to bind to a UnityEvent
        /// </summary>
        public virtual void UnmuteUI() { UnmuteTrack(MMSoundManager.MMSoundManagerTracks.UI); }
        
        /// <summary>
        /// Mutes the master track, QoL method ready to bind to a UnityEvent
        /// </summary>
        public virtual void MuteMaster() { MuteTrack(MMSoundManager.MMSoundManagerTracks.Master); }
        
        /// <summary>
        /// Unmutes the master track, QoL method ready to bind to a UnityEvent
        /// </summary>
        public virtual void UnmuteMaster() { UnmuteTrack(MMSoundManager.MMSoundManagerTracks.Master); }
        
        
        /// <summary>
        /// Sets the volume of the Music track to the specified value, QoL method, ready to bind to a UnityEvent
        /// </summary>
        public virtual void SetVolumeMusic(float newVolume) { SetTrackVolume(MMSoundManager.MMSoundManagerTracks.Music, newVolume);}
        /// <summary>
        /// Sets the volume of the SFX track to the specified value, QoL method, ready to bind to a UnityEvent
        /// </summary>
        public virtual void SetVolumeSfx(float newVolume) { SetTrackVolume(MMSoundManager.MMSoundManagerTracks.Sfx, newVolume);}
        /// <summary>
        /// Sets the volume of the UI track to the specified value, QoL method, ready to bind to a UnityEvent
        /// </summary>
        public virtual void SetVolumeUI(float newVolume) { SetTrackVolume(MMSoundManager.MMSoundManagerTracks.UI, newVolume);}
        /// <summary>
        /// Sets the volume of the Master track to the specified value, QoL method, ready to bind to a UnityEvent
        /// </summary>
        public virtual void SetVolumeMaster(float newVolume) { SetTrackVolume(MMSoundManager.MMSoundManagerTracks.Master, newVolume);}
        ...
        /// <param name="track"></param>
        /// <returns></returns>
        public virtual bool IsMuted(MMSoundManager.MMSoundManagerTracks track)
        {
			switch (track)
            {
                case MMSoundManager.MMSoundManagerTracks.Master:
        ...
        protected virtual void ControlTrack(MMSoundManager.MMSoundManagerTracks track, MMSoundManager.ControlTrackModes trackMode, float volume = 0.5f)
        {
            string target = "";
            ...
            switch (track)
            {
                case MMSoundManager.MMSoundManagerTracks.Master:
                    ...
                    if (trackMode == MMSoundManager.ControlTrackModes.Mute) { settingsSo.TargetAudioMixer.GetFloat(target, out settingsSo.Settings.MutedMasterVolume); settingsSo.Settings.MasterOn = false; }
                    else if (trackMode == MMSoundManager.ControlTrackModes.Unmute) { savedVolume = settingsSo.Settings.MutedMasterVolume; settingsSo.Settings.MasterOn = true; }
                    break;
                case MMSoundManager.MMSoundManagerTracks.Music:
                    target = settingsSo.Settings.MusicVolumeParameter;
                    if (trackMode == MMSoundManager.ControlTrackModes.Mute) { settingsSo.TargetAudioMixer.GetFloat(target, out settingsSo.Settings.MutedMusicVolume);  settingsSo.Settings.MusicOn = false; }
                    else if (trackMode == MMSoundManager.ControlTrackModes.Unmute) { savedVolume = settingsSo.Settings.MutedMusicVolume;  settingsSo.Settings.MusicOn = true; }
                    break;
                case MMSoundManager.MMSoundManagerTracks.Sfx:
                    target = settingsSo.Settings.SfxVolumeParameter;
                    if (trackMode == MMSoundManager.ControlTrackModes.Mute) { settingsSo.TargetAudioMixer.GetFloat(target, out settingsSo.Settings.MutedSfxVolume);  settingsSo.Settings.SfxOn = false; }
                    else if (trackMode == MMSoundManager.ControlTrackModes.Unmute) { savedVolume = settingsSo.Settings.MutedSfxVolume;  settingsSo.Settings.SfxOn = true; }
                    break;
                case MMSoundManager.MMSoundManagerTracks.UI:
                    target = settingsSo.Settings.UIVolumeParameter;
                    if (trackMode == MMSoundManager.ControlTrackModes.Mute) { settingsSo.TargetAudioMixer.GetFloat(target, out settingsSo.Settings.MutedUIVolume);  settingsSo.Settings.UIOn = false; }
                    else if (trackMode == MMSoundManager.ControlTrackModes.Unmute) { savedVolume = settingsSo.Settings.MutedUIVolume;  settingsSo.Settings.UIOn = true; }
                    break;
            }

            switch (trackMode)
            {
                case MMSoundManager.ControlTrackModes.Mute:
                    settingsSo.SetTrackVolume(track, 0f);
                    break;
                case MMSoundManager.ControlTrackModes.Unmute:
                    settingsSo.SetTrackVolume(track, settingsSo.MixerVolumeToNormalized(savedVolume));
                    break;
                case MMSoundManager.ControlTrackModes.SetVolume:
        ...
        public virtual void FadeTrack(MMSoundManager.MMSoundManagerTracks track, float duration, float initialVolume = 0f, float finalVolume = 1f, MMTweenType tweenType = null)
        {
        ...
        /// <param name="tweenType"></param>
        /// <returns></returns>
        protected virtual IEnumerator FadeTrackCoroutine(MMSoundManager.MMSoundManagerTracks track, float duration, float initialVolume, float finalVolume, MMTweenType tweenType)
        {
        ...
        public virtual void MuteSoundsOnTrack(MMSoundManager.MMSoundManagerTracks track, bool mute, float delay = 0f)
        {
        ...
        /// <param name="delay"></param>
        /// <returns></returns>
        protected virtual IEnumerator MuteSoundsOnTrackCoroutine(MMSoundManager.MMSoundManagerTracks track, bool mute, float delay)
        {
            if (delay > 0)
            {
        ...
        /// <summary>
        /// Returns all audio sources played with the specified ID
        /// </summary>
        /// <param name="ID"></param>
        /// <returns></returns>
        public virtual List<AudioSource> FindAllByClip(AudioClip clip)
        {
